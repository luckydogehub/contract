...
contract TestTokenOZ is ERC20 {
    ...
    function setDevFeeAddress(address devFeeAddress_) external onlyOwner {
        _devFeeAddress = devFeeAddress_;
    }

    function setWinnerFeeAddress(address winnerFeeAddress_) external onlyOwner {
        _winnerFeeAddress = winnerFeeAddress_;
    }
